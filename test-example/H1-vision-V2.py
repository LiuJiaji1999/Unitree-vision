...
class MainWindow(QMainWindow):
    ...
    def _build_leader_cockpit(self) -> QWidget:
        ...
        subtitle = QLabel("核心指标实时汇总 · 大数字展示")
        ...
        # cards.append(card)
        # card, self.cockpit_voltage_value, self.cockpit_voltage_hint = self._make_metric_card(
        #     "电池电压", "--", "LowState power_v"
        # )
        # cards.append(card)
    ...
    def generate_demo_report(self) -> None:
        ...
        lowstate = self.latest_robot_status.get("lowstate_main", {})
        detail_keys = [
            "update_time", "power_v", "power_a", "temperature_ntc1",
...
"""
    ...
    def append_log(self, text: str) -> None:
        ...
        if hasattr(self, "log_edit"):
            self.log_edit.append(f"[{now_text()}] {clean}")
